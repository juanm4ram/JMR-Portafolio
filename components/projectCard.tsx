...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div
        ref={overlayRef}
        className="absolute inset-0 flex flex-col justify-end p-6 pb-8 bg-gradient-to-t from-black/80 via-black/40 to-black/10 max-sm:px-5 max-sm:py-4 max-sm:pb-4 max-lg:p-8 max-lg:pb-8"
        style={{ opacity: 1 }}
      >
        ...
        {description && (
          <p className="font-clash-grotesk-regular text-sm text-white/80 mt-2 max-sm:text-[10px] max-lg:text-base">
            {description}
          </p>
        )}
            ...
            {tags.map((tag) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs font-clash-grotesk-regular text-white/70 max-sm:text-[8px] max-lg:text-base">
                    {tag}
                  </span>
                </span>
              );
            ...
            {githubUrl && (
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-5 h-5 max-sm:w-5 max-sm:h-5 max-lg:w-8 max-lg:h-8"
                >
